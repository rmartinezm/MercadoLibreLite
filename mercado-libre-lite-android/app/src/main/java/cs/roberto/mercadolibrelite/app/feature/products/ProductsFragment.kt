...
import cs.roberto.mercadolibrelite.app.databinding.FragmentProductsBinding
import cs.roberto.mercadolibrelite.app.feature.products.adapter.ItemReferenceAdapter
...
class ProductsFragment : Fragment() {
    ...
    private fun onItemReferenceActionClickListener(itemReference: ItemReference) {
        val direction =
            ProductsFragmentDirections.actionProductsFragmentToProductDetailsActivity(itemReference.id)
